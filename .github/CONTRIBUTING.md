# CONTRIBUTING - Guide originally from /tg/station.

## Reporting Issues

Please be comprehensive when reporting issues. If in doubt seek guidance on Discord.

## Introduction

Hello and welcome to Planetfall's contributing page. You are here because you are curious or interested in contributing - thank you! Everyone is free to contribute to this project as long as they follow the simple guidelines and specifications below; at Planetfall, we strive to maintain code stability and maintainability, and to do that, we need all pull requests to hold up to those specifications. It's in everyone's best interests - including yours! - if the same bug doesn't have to be fixed twice because of duplicated code.
...
* We ask that you use the changelog system to document your change, which prevents our players from being caught unaware by changes - you can find more information about this [on this wiki page](https://github.com/Planetfall/Planetfall/wiki/Guide-to-Changelogs).
...
When contributing to this repository, there are a few golden rules to be followed, except in extreme circumstances!

* No pushes to the repository master.
* No pushes to master on created forks. Please use the concept of atomic commits, create a branch for each feature.
* Do not change the git history. This can cause a repository to implode VERY quickly.
* No force pushes after a merge. That means once you merge it, force pushing can damage the history. Use other methods to revert.
* Controversial changes must be discussed before merging. It's easier to NOT merge than to undo a merge.
* Squashing must be discussed before merging.

* No Self Merging. Ideally. Really though, please let someone else have a look whenever possible.

## Getting Started

Planetfall is currently in development and therefore has certain aims and goals which we are progressing towards. Please check Discord for more information on what it would be best to contribute with.
...
We have a [list of guides on the wiki](http://www.tgstation13.org/wiki/index.php/Guides#Development_and_Contribution_Guides) that will help you get started contributing to Planetfall with Git and Dream Maker. For beginners, it is recommended you work on small projects like bugfixes at first. If you need help learning to program in BYOND, check out this [repository of resources](http://www.byond.com/developer/articles/resources).

A list of open issues can be found here. (https://github.com/Planetfall/Planetfall/issues)

You can of course, as always, ask for help on Discord and we will help you as best we can.
...
### No duplicated code
Copying code from one place to another may be suitable for small, short-time projects, but Planetfall is a long-term project and highly discourages this.
